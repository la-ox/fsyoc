...
class Nav_Menu extends Widget_Base {
	...
	protected function render() {
		...
		if ( 'dropdown' !== $settings['layout'] ) {
			$this->add_render_attribute( 'main-menu', 'class', 'elementor-nav-menu--layout-' . $settings['layout'] );
		...
		?>
		<nav <?php echo $this->get_render_attribute_string( 'main-menu' ); ?>><?php echo $menu_content; ?></nav>
		<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?>>
			<i class="eicon-temp"></i>
		</div>
		<nav class="elementor-nav-menu--dropdown elementor-nav-menu__container"><?php echo $menu_content; ?></nav>
		<?php
		remove_filter( 'nav_menu_link_attributes', [ $this, 'handle_link_classes' ], 10 );
