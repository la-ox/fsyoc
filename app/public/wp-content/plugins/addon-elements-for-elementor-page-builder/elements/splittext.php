			...
			<div id="eae-at-<?php echo $this->get_id(); ?>" class="eae-st-transform-text-wrapper">
				<div <?php echo $this->get_render_attribute_string( 'eae-st-transform-text' ); ?>>
					<?php if($settings['split_mode'] == 'text'){ ?> 
						<div <?php echo $this->get_render_attribute_string( 'eae-st-split-text' ); ?>><?php echo substr($settings['text'], 0, $settings['split_count']); ?></div><div <?php echo $this->get_render_attribute_string( 'eae-st-rest-text' ); ?>><?php echo substr($settings['text'], $settings['split_count'], strlen($settings['text']) - $settings['split_count']); ?></div>
					<?php } else { ?>
					<?php							
