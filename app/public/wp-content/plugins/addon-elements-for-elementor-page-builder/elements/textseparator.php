...
class Widget_TextSeparator extends Widget_Base {
	...
	protected function render( ) {
		...
		$this->add_render_attribute( 'heading', 'class', 'eae-separator-title' );
        ...
        if($settings['title'] != ''){
            $separator_html .= sprintf( '<%1$s %2$s>%3$s</%1$s>', $settings['html_tag'], $this->get_render_attribute_string( 'heading' ), $settings['title'] );
        }
